...
module.exports.passCheckForm = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
module.exports.passCheck = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const username = req.body.username;
    const passCheck = req.body.share_pass_check;
    yield User.findOne({ username: username }).then((u) => __awaiter(void 0, void 0, void 0, function* () {
...
module.exports.discoverCollection = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield User.findOne({ username: username }).then((u) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (u && u.share_collection === true) {
            ...
            if (req.session.discoverToken && req.session.discoverToken.includes(id)) {
                ...
                const artPieces = yield ArtPiece.find({
                    archival: !{ $in: ["true"] },
                    user_id: `${u._id}`,
                });
...
module.exports.discoverPiece = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    const owner = yield User.findById({ _id: p.user_id });
    if (origin &&
