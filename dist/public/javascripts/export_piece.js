...
createCanvas_both = function () {
    ...
    let createCanvas_cat = function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (pImage) {
                ...
                if (pImage.complete) {
                    yield ctx.drawImage(pImage, pieceImg_X, pieceImg_Y, imageWidth, imageHeight);
                }
                else {
    ...
    let createCanvasLink = function (canvasId, linkId) {
        $(linkId).click(function () {
            ...
            $(this)
                .parent()
                .attr("download", `${canvasId.substring(1)}_label_for_${pTitle}_by_${pArtist}.png`);
        });
    };
    createCanvasLink("#canvas_cat", "#export-cat");
    createCanvasLink("#canvas_mus", "#export-mus");
};
//# sourceMappingURL=export_piece.js.map