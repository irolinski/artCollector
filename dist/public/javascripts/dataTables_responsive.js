...
(function (c) {
    ...
    c.extend(j.prototype, {
        ...
        _columnsVisiblity: function (a) {
            var b = this.s.dt, d = this.s.columns, e, f, g = d
                .map(function (a, b) {
        ...
        _classLogic: function () {
            var a = this, b = this.c.breakpoints, d = this.s.dt, e = d
                .columns()
                .eq(0)
                .map(function (a) {
        ...
        _resizeAuto: function () {
            ...
            if (this.c.auto &&
                -1 !==
                    c.inArray(!0, c.map(b, function (a) {
                        return a.auto;
                    }))) {
                a.table().node();
                var d = a.table().node().cloneNode(!1), e = c(a.table().header().cloneNode(!1)).appendTo(d), f = c(a.table().body()).clone(!1, !1).empty().appendTo(d), g = a
                    .columns()
                    .header()
                    .filter(function (b) {
                ...
                c(f)
                    ...
                    .css("display", "");
                if ((f = a.table().footer())) {
                    var f = c(f.cloneNode(!1)).appendTo(d), h = a
                        .columns()
                        .footer()
                        .filter(function (b) {
                        return a.column(b).visible();
            ...
            return function (b, d, e) {
                if (d)
                    ...
                    var f = function () {
                        ...
                        .append(c('<div class="dtr-modal-display"/>')
                        .append(c('<div class="dtr-modal-content"/>').append(e()))
                        .append(c('<div class="dtr-modal-close">&times;</div>').click(function () {
                        f();
                    })))
...
//# sourceMappingURL=dataTables_responsive.js.map