...
(function ($) {
    ...
    var setNamespacedEvents = function (d) {
        d.form
            ...
            .on("change.dirty click.dirty keyup.dirty keydown.dirty blur.dirty", function (e) {
            d.checkValues(e);
        });
        d.form.on("dirty", function () {
            if (typeof d.options.onDirty !== "function")
                return;
            d.options.onDirty();
        });
        d.form.on("clean", function () {
            if (typeof d.options.onClean !== "function")
                return;
            d.options.onClean();
        });
    };
    ...
    $.fn.dirty = function (options) {
        if (typeof options === "string" &&
            /^(isDirty|isClean|refreshEvents|resetForm|setAsClean|setAsDirty|showDirtyFields)$/i.test(options)) {
...
//# sourceMappingURL=jquery.dirty.js.map