...
router.route('/')
    ...
    .post(isLoggedIn, upload.array('images'), catchAsync(collection.postNewPiece));

router.get('/new', isLoggedIn, collection.newPieceForm)

router.post('/export_collection', isLoggedIn, catchAsync(collection.exportToXlsx));
...
router.get('/show/:id/edit/images', isLoggedIn, catchAsync(collection.editImages))
